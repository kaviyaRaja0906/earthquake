      ...
      >
        <Popup>
          <h6 className="popup-txt">
            Earthquake recorded on {getMonth(quake.properties.DateTime)} {getDate(quake.properties.DateTime)}, had a depth of {quake.properties.depth} km and magnitude of {quake.properties.magnitude} in {quake.properties.region}
          </h6>
        </Popup>
      </Marker>
    );
